    ...
    public void handleGuiPacket(NBTTagCompound tag, EntityPlayer player)
    {
        if (tag.hasKey("uid"))
        {
            try
            {
                ...
                player.openGui(EnhancedPortals.instance, GuiEnums.GUI_CONTROLLER.CONTROLLER_A.ordinal(), controller.getWorld(), (int) player.posX, (int) player.posY, (int) player.posZ);
            }
