...
public class ContainerNetworkInterfaceGlyphs extends BaseContainer
{
    ...
    public void handleGuiPacket(NBTTagCompound tag, EntityPlayer player)
    {
        if (tag.hasKey("nid"))
        {
            ...
            player.openGui(EnhancedPortals.instance, GuiEnums.GUI_MISC.NETWORK_INTERFACE_A.ordinal(), controller.getWorld(), (int) player.posX, (int) player.posY, (int) player.posZ);
        }
    }
}
