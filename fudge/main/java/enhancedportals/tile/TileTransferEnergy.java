...
public class TileTransferEnergy extends TileFrameTransfer //implements IEnergyProvider, IEnergyReceiver, SimpleComponent
{
    ...
    //TODO IEnergyHandler[] handlers = new IEnergyHandler[6];
    ...
    public boolean activate(EntityPlayer player, ItemStack stack)
    {
        ...
        if (stack != null && controller != null && controller.isFinalized())
        {
            ...
            {
                GuiHandler.openGui(player, this, GuiEnums.GUI_TRANFER.TRANSFER_ENERGY.ordinal());
                return true;
            }
