...
import static enhancedportals.utility.GuiEnums.GUI_ADDRESS_BOOK.*;
import static enhancedportals.utility.GuiEnums.GUI_CONTROLLER.*;
import static enhancedportals.utility.GuiEnums.GUI_DIAL.*;
import static enhancedportals.utility.GuiEnums.GUI_MISC.*;
import static enhancedportals.utility.GuiEnums.GUI_TEXTURE.*;
import static enhancedportals.utility.GuiEnums.GUI_TRANFER.*;
...
public class GuiHandler implements IGuiHandler
{
    ...
    {
        player.openGui(EnhancedPortals.instance, gui, player.world, (int) player.posX, (int) player.posY, (int) player.posZ);
    }
