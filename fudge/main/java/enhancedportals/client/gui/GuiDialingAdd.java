...
//        todo itemRender.renderWithColor = false;
        ItemStack frame = new ItemStack(enhancedportals.block.Blocks.PORTAL_FRAME, 0, 0), portal = new ItemStack(Blocks.PORTAL, 0, 0);
...
//       todo     drawItemStack(portal, 80, 85);
    ...
    protected void actionPerformed(GuiButton button)
    {
        if (button.id == 0)
        {
            EnhancedPortals.packetPipeline.sendToServer(new PacketRequestGui(dial, GuiEnums.GUI_DIAL.DIAL_B));
        }
        ...
        {
            isEditing = true;
            EnhancedPortals.packetPipeline.sendToServer(new PacketRequestGui(dial, GuiEnums.GUI_TEXTURE.TEXTURE_DIAL_SAVE_B));
        }
        else if (button.id == 102)
        {
            isEditing = true;
            EnhancedPortals.packetPipeline.sendToServer(new PacketRequestGui(dial, GuiEnums.GUI_TEXTURE.TEXTURE_DIAL_SAVE_C));
        }
    }
}
