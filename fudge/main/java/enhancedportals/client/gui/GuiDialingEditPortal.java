...
public class GuiDialingEditPortal extends GuiTexturePortal
{
    ...
    protected void actionPerformed(GuiButton button)
    {
        ...
        {
            didSave = true;
            EnhancedPortals.packetPipeline.sendToServer(new PacketRequestGui(dial, returnToEdit ? GuiEnums.GUI_TEXTURE.TEXTURE_DIAL_EDIT_A: GuiEnums.GUI_TEXTURE.TEXTURE_DIAL_SAVE_A));
        }
