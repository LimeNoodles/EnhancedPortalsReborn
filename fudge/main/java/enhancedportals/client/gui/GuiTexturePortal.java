...
public class GuiTexturePortal extends BaseGui implements IFakeSlotHandler
{
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2)
    {
        ...
        ItemStack frame = new ItemStack(enhancedportals.block.Blocks.PORTAL_FRAME, 0, 0);
    ...
    protected void actionPerformed(GuiButton button)
    {
        ...
        {
            EnhancedPortals.packetPipeline.sendToServer(new PacketRequestGui(controller, GuiEnums.GUI_TEXTURE.TEXTURE_A));
        }
        else if (button.id == 501)
        {
            EnhancedPortals.packetPipeline.sendToServer(new PacketRequestGui(controller, GuiEnums.GUI_TEXTURE.TEXTURE_C));
        }
    }
