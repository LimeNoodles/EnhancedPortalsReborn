...
public class ItemAddressBook extends ItemBase
{
   ...
   // @Override
    ...
    public ActionResult<ItemStack> onItemRightClick(ItemStack itemStack, World world, EntityPlayer player, EnumHand hand)
    {
        ...
        GuiHandler.openGui(player, GuiEnums.GUI_ADDRESS_BOOK.ADDRESS_BOOK_A.ordinal());
