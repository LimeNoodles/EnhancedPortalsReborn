...
import com.teamsevered.enhancedportalsreborn.util.ComputerUtils;
...
//    @Override
    public boolean activate(EntityPlayer player, ItemStack stack)
    {
        ...
        if (controller != null && controller.isFinalized())
        {
            ...
            {
                GuiHandler.openGui(player, this, GuiEnums.GUI_DIAL.DIAL_A.ordinal());
            }
            ...
            {
                player.sendMessage(new TextComponentString(Localization.getChatNotify("unimplemented")));
            }
        }
        else
        {
            GuiHandler.openGui(player, this, GuiEnums.GUI_DIAL.DIAL_B.ordinal());
        }
        return true;
    }
