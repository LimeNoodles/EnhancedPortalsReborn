...
import com.teamsevered.enhancedportalsreborn.client.gui.*;
import com.teamsevered.enhancedportalsreborn.inventory.*;
...
import static com.teamsevered.enhancedportalsreborn.util.GuiEnums.GUI_ADDRESS_BOOK.*;
import static com.teamsevered.enhancedportalsreborn.util.GuiEnums.GUI_CONTROLLER.*;
import static com.teamsevered.enhancedportalsreborn.util.GuiEnums.GUI_DIAL.*;
import static com.teamsevered.enhancedportalsreborn.util.GuiEnums.GUI_MISC.*;
import static com.teamsevered.enhancedportalsreborn.util.GuiEnums.GUI_TEXTURE.*;
import static com.teamsevered.enhancedportalsreborn.util.GuiEnums.GUI_TRANFER.*;
...
public class GuiHandler implements IGuiHandler
{
    ...
    {
        player.openGui(EnhancedPortalsReborn.instance, gui, tile.getWorld(), tile.getPos().getX(), tile.getPos().getY(), tile.getPos().getZ());
    }

    public static void openGui(EntityPlayer player, int gui)
    {
        player.openGui(EnhancedPortalsReborn.instance, gui, player.world, (int) player.posX, (int) player.posY, (int) player.posZ);
    }
    ...
    public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z)
    {
        ...
        {
            //todo return new ContainerTransferFluid((TileTransferFluid) tile, player.inventory);
        }
        else if (ID == TRANSFER_ENERGY.ordinal())
        {
