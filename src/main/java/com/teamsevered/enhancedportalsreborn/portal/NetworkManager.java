...
public class NetworkManager
{
    ...
    public NetworkManager(FMLServerStartingEvent event)
    {
        ...
        portalFile = new File(EnhancedPortalsReborn.proxy.getWorldDir(), "EP3_PortalLocations.json");
        networkFile = new File(EnhancedPortalsReborn.proxy.getWorldDir(), "EP3_PortalNetworks.json");
