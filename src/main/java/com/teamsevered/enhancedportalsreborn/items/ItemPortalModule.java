...
import com.teamsevered.enhancedportalsreborn.client.PortalParticleFX;
...
import com.teamsevered.enhancedportalsreborn.util.IPortalModule;
...
public class ItemPortalModule extends ItemBase implements IPortalModule
{
 ...
 //todo fix potion
    ...
    public ItemPortalModule(String name)
    {
        super(name);
        instance = this;
        setMaxDamage(0);
