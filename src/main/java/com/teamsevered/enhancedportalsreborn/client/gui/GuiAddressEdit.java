...
import com.teamsevered.enhancedportalsreborn.inventory.ContainerAddressEdit;
...
public class GuiAddressEdit extends GuiAddressBookAdd
{
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        if (receivedData)
        {
            ...
            {
                isEditing = true;
                EnhancedPortalsReborn.packetPipeline.sendToServer(new PacketRequestGui(player, GuiEnums.GUI_ADDRESS_BOOK.ADDRESS_BOOK_E));
            }
        }
    }
