...
import com.teamsevered.enhancedportalsreborn.client.gui.elements.ElementScrollPortalIcons;
...
import com.teamsevered.enhancedportalsreborn.inventory.ContainerTexturePortal;
...
public class GuiTexturePortal extends BaseGui implements IFakeSlotHandler
{
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2)
    {
        ...
        ItemStack frame = new ItemStack(com.teamsevered.enhancedportalsreborn.init.Blocks.PORTAL_FRAME, 0, 0);
    ...
    protected void actionPerformed(GuiButton button)
    {
        ...
        {
            EnhancedPortalsReborn.packetPipeline.sendToServer(new PacketRequestGui(controller, GuiEnums.GUI_TEXTURE.TEXTURE_A));
        }
