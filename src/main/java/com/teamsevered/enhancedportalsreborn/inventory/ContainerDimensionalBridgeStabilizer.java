...
import com.teamsevered.enhancedportalsreborn.client.gui.GuiDimensionalBridgeStabilizer;
import com.teamsevered.enhancedportalsreborn.inventory.slot.SlotDBS;
    ...
    public void detectAndSendChanges()
    {
        ...
        for (int i = 0; i < this.listeners.size(); i++)
        {
            ...
            if (lastPower != currentPower || lastMaxPower != currentMaxPower)
            {
                ...
                EnhancedPortalsReborn.packetPipeline.sendTo(new PacketGuiData(tag), (EntityPlayerMP) iContainerListener);
            }
