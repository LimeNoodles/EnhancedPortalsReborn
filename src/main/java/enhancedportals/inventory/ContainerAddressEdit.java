...
public class ContainerAddressEdit extends BaseContainer
{
    ...
    public void handleGuiPacket(NBTTagCompound tag, EntityPlayer player)
    {
        if (tag.hasKey("id") && tag.hasKey("uid") && tag.hasKey("texture") && tag.hasKey("name"))
        {
            ...
            player.openGui(EnhancedPortals.instance, Reference.GuiEnums.GUI_ADDRESS_BOOK.ADDRESS_BOOK_A.ordinal(), player.world, (int) player.posX, (int) player.posY, (int) player.posZ);
        }
    }
}
