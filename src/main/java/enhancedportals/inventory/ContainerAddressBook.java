    ...
    public void handleGuiPacket(NBTTagCompound tag, EntityPlayer player)
    {
        if (tag.hasKey("edit"))
        {
            ...
            if (addressBook.glyphList.size() > id)
            {
                ...
                player.openGui(EnhancedPortals.instance, Reference.GuiEnums.GUI_ADDRESS_BOOK.ADDRESS_BOOK_D.ordinal(), Minecraft.getMinecraft().world, (int) player.posX, (int) player.posY, (int) player.posZ);
