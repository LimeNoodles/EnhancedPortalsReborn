...
public class CommonProxy
{
    ...
    public static boolean Notify(EntityPlayer player, String lateVers)
    {
        if (CONFIG_UPDATE_NOTIFIER)
        {
            ...
            player.sendMessage(new TextComponentString(ChatFormatting.GOLD + "[EnhancedPortals] " + ChatFormatting.WHITE + "has been updated to v" + lateVers + " :: You are running v" + EnhancedPortals.MOD_VERSION));
            return true;
        }
        else
        {
